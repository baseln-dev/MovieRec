...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 px-4">
	<div class="w-full max-w-md">
		<div class="bg-slate-800/50 backdrop-blur-md rounded-lg shadow-2xl p-8 border border-slate-700">
			<h1 class="text-3xl font-bold text-white mb-2 text-center">Recover Your Account</h1>
			<p class="text-slate-400 text-sm text-center mb-8">Enter your recovery code to regain access</p>
			
			<form method="post" use:enhance class="space-y-6">
				<div>
					<label for="form-totp.code" class="block text-sm font-medium text-slate-300 mb-2">Recovery Code</label>
					<input 
						id="form-totp.code" 
						name="code" 
						required 
			...
			<div class="mt-8 pt-8 border-t border-slate-700 text-center">
				<a href="/2fa" class="text-purple-400 hover:text-purple-300 text-sm transition">
